  ...
  <div class="fly-panel fly-signin">
    <div class="fly-panel-title">
      ...
      <a href="javascript:;"
        class="fly-link"
        id="LAY_signinTop"
        @click="showTop()">活跃榜<span></span></a>
      <span class="fly-signin-days"
        v-show="isLogin || isSign">已连续签到<cite>{{count}}</cite>天</span>
    </div>
    <div class="fly-panel-main fly-signin-main">
      <template v-if="!isSign"><button class="layui-btn layui-btn-danger"
          id="LAY_signin"
          @click="sign()">今日签到</button>
        <span>可获得<cite>{{favs}}</cite>飞吻</span></template>
    ...
    <lsf-signinfo :isShow='isShow'
      @closeModal="close()"></lsf-signinfo>
    <lsf-signlist :isShow='showlist'
      @closeModal="close()"></lsf-signlist>
  </div>
</template>
...
export default {
  name: 'Sign',
  components: {
    'lsf-signinfo': SignInfo,
    'lsf-signlist': SignList
  },
  data () {
    return {
      isShow: false,
